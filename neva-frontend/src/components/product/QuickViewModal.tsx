            ...
            {product && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    >
                        ...
                        <div className="flex-1 p-5 md:p-7 overflow-y-auto flex flex-col justify-between">
                            <div>
                                ...
                                <div className="flex items-center gap-1.5 mb-4">
                                    ...
                                    <span className="text-xs font-medium text-violet-400 hover:underline cursor-pointer">
                                        Write a review
                                    </span>
                                </div>

                                {/* Description */}
                                <p className="text-zinc-650 dark:text-zinc-300 text-sm leading-relaxed mb-4">
                                    {product.description}
                                </p>

                                {/* Technical Specs List */}
                                <div className="mb-5">
                                    <h4 className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 mb-2.5">
                            ...
                            <div className="pt-4 border-t border-zinc-200 dark:border-zinc-800 flex flex-col sm:flex-row gap-3 items-center justify-between mt-auto">
                                ...
                                <button
                                    onClick={() => {}}
                                    className="flex items-center justify-center gap-2 rounded-xl bg-violet-600 hover:bg-violet-500 active:scale-95 text-white font-bold text-sm px-6 py-3 w-full sm:w-auto transition-all duration-200 shadow-lg shadow-violet-600/10"
                                >
