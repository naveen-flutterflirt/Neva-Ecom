...
export const INDIAN_STATES_AND_DISTRICTS: StateDistrictMap = {
  "Andhra Pradesh": [
    ...
    "Dr. B.R. Ambedkar Konaseema", "Ntr", "Nandyal", "Palnadu", "Parvathipuram Manyam", "Polavaram",
    "Prakasam", "Sri Potti Sriramulu Nellore", "Sri Sathya Sai", "Srikakulam", "Tirupati", 
    "Visakhapatnam", "Vizianagaram", "West Godavari", "YSR Kadapa", "Krishna", "Kurnool", "Markapuram"
  ],
  "Arunachal Pradesh": [
    "Anjaw", "Changlang", "Dibang Valley", "East Kameng", "East Siang", 
    "Bichom", "Kamle", "Keyi Panyor", "Kra Daadi", "Kurung Kumey", "Leparada", 
  ...
  "Assam": [
    ...
    "Karbi Anglong", "Sribhumi", "Kokrajhar", "Lakhimpur", "Majuli", 
    "Morigaon", "Nagaon", "Nalbari", "Sivasagar", "Sonitpur", 
    "South Salmara-Mankachar", "Tinsukia", "Udalguri", "West Karbi Anglong", "Tamulpur"
  ],
  "Bihar": [
    "Araria", "Arwal", "Aurangabad", "Banka", "Begusarai", 
    "Bhagalpur", "Bhojpur", "Buxar", "Darbhanga", "Purba Champaran", 
    ...
    "Supaul", "Vaishali", "Pashchim Champaran"
  ],
  "Chhattisgarh": [
    ...
    "Uttar Bastar Kanker", "Khairagarh-Chhuikhadan-Gandai", "Kondagaon", "Korba", "Koriya", 
  ...
  "Gujarat": [
    ...
    "Bharuch", "Bhavnagar", "Botad", "Chhotaudepur", "Dahod", "Dangs", 
    "Devbhumi Dwarka", "Gandhinagar", "Gir Somnath", "Jamnagar", "Junagadh", 
    "Kheda", "Kachchh", "Mahisagar", "Mahesana", "Morbi", 
  ...
  "Madhya Pradesh": [
    ...
    "Khandwa (East Nimar)", "Khargone", "Mandla", "Mandsaur", "Morena", 
    "Maihar", "Mauganj", "Narsinghpur", "Neemuch", "Niwari", "Panna", "Pandhurna",
  ...
  "Maharashtra": [
    ...
    "Kolhapur", "Latur", "Mumbai", "Mumbai Suburban", "Nagpur", 
  ...
  "Meghalaya": [
    "East Garo Hills", "East Jaintia Hills", "East Khasi Hills (Shillong)", "Eastern West Khasi Hills", "North Garo Hills", 
  ...
  "Nagaland": [
    "Chumoukedima", "Dimapur", "Kiphire", "Meluri", "Kohima", "Longleng", 
    "Mokokchung", "Mon", "Niuland", "Noklak", "Peren", 
    "Phek", "Shamator", "Tseminyu", "Tuensang", "Wokha", 
    "Zunheboto"
  ],
  "Odisha": [
    "Anugola", "Balangir", "Baleshwar", "Baragada", "Bhadrak", 
    "Boudh", "Cuttack", "Debagada", "Dhenkanal", "Gajapati", 
    "Ganjam", "Jagatsinghapur", "Jajpur", "Jharsuguda", "Kalahandi", 
  ...
  "Sikkim": [
    "Gangtok (East Sikkim)", "Gyalshing (West Sikkim)", "Mangan (North Sikkim)", "Namchi (South Sikkim)", "Pakyong", 
    "Soreng"
  ],
  "Tamil Nadu": [
    "Ariyalur", "Chengalpattu", "Chennai", "Coimbatore", "Cuddalore", 
    "Dharmapuri", "Dindigul", "Erode", "Kallakurichi", "Kanchipuram", "Kanyakumari (Nagercoil)", 
